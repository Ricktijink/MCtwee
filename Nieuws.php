			...
			<div class="column margin-column-right">
				...
				<div class="block">
					...
					<div class="block_contentwrapper">
						<div class="block_text editable" id="news1"><p class="standard_text"><strong>ISU (InloopSpreekUur):</strong> <br>Momenteel geen wachttijd! Iedere week op dinsdag van 17.00u-18.00u Iedere week op vrijdag van 09.00u-10.00u <br><br><strong>MDP (MultiDisciplinair/Arbeid &amp; Gezondheid):</strong> <br>Momenteel geen wachttijd! Intake AG: binnen 5 werkdagen na autorisatie/aanvraag intake AG Rapportage: binnen 5 werkdagen na intake Start behandeling: binnen 5 werkdagen na autorisatie MDP <br><br><strong>Eerstelijns: <br>Psychologie (contractvrij):</strong> <br>Intake en/of behandeling: vanaf 1 februari 2019 <br><strong>Oefentherapie (contractvrij):</strong> Intake en/of start behandeling: vanaf 1 februari 2019 <br><br><strong>Fysiotherapie (gecontracteerd):</strong> <br>Check de site van onze samenwerkingspartner: www.fysiobinnenstad.nl <br><strong>Psychologie (gecontracteerd):</strong> <br>Tijdens ons ISU kunnen wij u meer vertellen over onze samenwerkingspartners</p></div>
						<div class="break"></div>
					</div>
				</div>
				<!-- Block 2 - Werknemer -->
