...
<body>
	...
	<div id="left_container" class="red_container">
		...
		<!-- Intro page -->
		<div id="intro_block">
			<h1 class="main_title editable" id="untitled-region-1">Kwaliteit</h1><br/>
			<span class="main_subtitle editable" id="untitled-region-2">- Geen kwantiteit - Geen lopende bandwerk - Wel kwaliteit - Wel duurzaamheid</span>
		</div>
	</div>
			...
			<div class="column margin-column-right">
				...
				<div class="block margin-column-top">
					...
					<div class="block_contentwrapper">
						...
						<div class="block_button">
							<hr/>
							<a class="button_red" href="Kwaliteit_Samenwerking.php">Lees Meer</a>
						</div>
						<div class="break"></div>
					</div>
				</div>
